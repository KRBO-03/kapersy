...
void _CYCLIC ProgramCyclic(void)
{
	...
	if (flag_wait == 3)
	{
		if((g_command[0] == 'G')&& (g_command[1] == '0') && (g_command[2] == '1') && (g_command[4] == 'X') && (g_command[9] == 'Y') && (g_command[14] == 'Z') && (g_command[19] == 'F'))
		{
			...
			V = strtol(string_to_number, 0, 10);
